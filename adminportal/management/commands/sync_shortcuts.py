...
CANONICAL_SHORTCUTS = [
    ...
    },
    {
        ...
        'key_display': 'C',
        'label': 'Clear Screen',
        'description': 'Run the existing clear action when visible.',
        'action_type': 'page_action',
        'target_selector': '#clearBtn, #clearJigBtn, .jig-clear-btn, .clear-scanned-btn, [data-action="clear-all"], [data-action="clear"]',
        'fallback_selector': '',
        'contexts': ['global'],
        'allow_in_modal': True,
        'allow_when_typing': False,
